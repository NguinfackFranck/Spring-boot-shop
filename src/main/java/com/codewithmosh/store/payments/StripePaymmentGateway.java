...
@Service
public class StripePaymmentGateway implements PaymentGateway {
    @Value("${websiteUrl}")
    ...
    private SessionCreateParams.LineItem.PriceData createPriceData(OrdersItem item) {
    ...
    private  SessionCreateParams.LineItem.PriceData.ProductData createProductData(OrdersItem item) {
